...
- [Указания по выполнению работы](#указания-по-выполнению-работы)
  ...
  - [Приложение 2. Функция для печати таблицы результатов](#приложение-2-функция-для-печати-таблицы-результатов)
- [Структуры в C++](#структуры-в-c)
- [Передача в функцию в качестве параметров одномерных массивов и имен функции](#передача-в-функцию-в-качестве-параметров-одномерных-массивов-и-имен-функции)
...
Для уменьшения объёма вычислений множитель \( \Delta x \) следует вынести за знак суммы. Тогда в цикле нужно выполнять только суммирование, а затем полученную сумму один раз умножить на \( \Delta x \).
...
(Текст и примеры по структурам — см. исходный HTML.)

## Передача в функцию в качестве параметров одномерных массивов и имён функций

(Текст и примеры — см. исходный HTML.)

---

*Исходный файл HTML: lab-06.html*  fileciteturn0file0
